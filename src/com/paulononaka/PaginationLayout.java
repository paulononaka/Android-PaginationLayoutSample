...
public class PaginationLayout extends LinearLayout {
	...
	// creates the class that will control the gestures and apply it in the scroll
	...
	mScroll.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
	...
	btnPrevious.setLayoutParams(new LayoutParams(150,
		LayoutParams.FILL_PARENT));
	...
	mBar.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
